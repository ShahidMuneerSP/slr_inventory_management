...
class _SalesCustomerPageState extends State<SalesCustomerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 10),
          Expanded(child: _buildSalesList(size)),
        ],
      ),
  ...
  Widget _buildSalesList(Size size) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          ...
          child: _buildSaleCard(sale, context, size),
        );
      },
    );
  }

  Widget _buildSaleCard(Map<String, String> sale, context, Size size) {
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: sale['paymentType'] == 'Cash'
                                  ? const Color.fromARGB(255, 236, 247, 240)
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: FontWeight.w500,
                                color: sale['paymentType'] == 'Cash'
                                    ? const Color.fromARGB(255, 4, 114, 79)
                                    : const Color.fromARGB(255, 6, 47, 136),
                              ),
                            ),
                          ),
                          const SizedBox(height: 5),
